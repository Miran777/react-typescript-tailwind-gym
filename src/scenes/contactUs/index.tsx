            ...
            <div className='mt-10 justify-between gap-8 md:flex'>
                <motion.div
                    ...
                    <form
                        target="_blank"
                        onSubmit={onSubmit}
                        action="https://formsubmit.co/55ae02c822b98a9329fbb5b6cadaaa95"
                        method="POST"
                    >
                        ...
                        <button 
                            className='mt-5 rounded-lg bg-secondary-500 px-20 py-3 transition duration-50 hover:text-white hover:bg-primary-500'
                            type='submit'>
                                SUBMIT
                        </button>
                    </form>
